...
require_once( trailingslashit( get_template_directory() ). 'includes/post-types/events.php');
...
require_once( trailingslashit( get_template_directory() ). 'includes/post-types/news.php');
